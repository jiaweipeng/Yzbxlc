...
public class SendMailUtil {
	...
	private static final String from = getProper("username");
	private static final String fromName = getProper("fromname");
	private static final String charSet = "utf-8";
	private static final String username = getProper("username");
	private static final String password = getProper("password");
	...
	static {
		...
		hostMap.put("smtp.yzbxlc", "smtp.yzbxlc.com");
	}
	...
	public static void sendFtlMail(String toMailAddr, String subject,
		...
		try {
			...
			hemail.setSmtpPort(Integer.parseInt(getProper("port")));
	...
	public static void sendCommonMail(String toMailAddr, String subject,String message) {
		...
		try {
			...
			hemail.setSSLOnConnect(true);//setSSL(true);
...
//	@SuppressWarnings("unchecked")
	...
	public static void main(String[] args) {
		...
		//sendFtlMail("1148485810@qq.com", "sendemail test!", templatePath, map);
		sendCommonMail("1148485810@qq.com","nihao","测试");
