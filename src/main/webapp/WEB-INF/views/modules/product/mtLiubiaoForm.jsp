...
<body>
	...
	<form:form id="inputForm" modelAttribute="mtProduct" action="${ctx}/product/mtProduct/liubiao" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="product:mtProduct:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="确认流标"/>&nbsp;</shiro:hasPermission>
