...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mtuser/mtUser/">经纪人待审批列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="mtUser" action="${ctx}/mtuser/mtUser/agentList" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="mtUser">
			<tr>
				...
				<shiro:hasPermission name="mtuser:mtUser:edit"><td>
    				<a href="${ctx}/mtuser/mtUser/agentForm?id=${mtUser.id}">修改</a>
