...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/notice/mtNotice/nlist">通知列表</a></li>
		<li class="active"><a href="javascript:void(0);">通知内容<shiro:lacksPermission name="notice:mtNotice:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mtNotice" action="${ctx}/notice/mtNotice/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<!--<shiro:hasPermission name="notice:mtNotice:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>-->
