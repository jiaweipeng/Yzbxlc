	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>联系电话</th>
				<th>提现总金额</th>
				<shiro:hasPermission name="mtcash:mtCash:view"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="mtUser">
		<c:if test="${!empty  fns:getCountlipsTrdAmt(mtUser.id)}">
			<tr>
				<td>
					${mtUser.userNickName}
				</td>
				...
				<td>
					${fns:getCountlipsTrdAmt(mtUser.id)}
				</td>
				
				<shiro:hasPermission name="mtcash:mtCash:view"><td>
    				<a href="${ctx}/mtcash/mtCash/list?id=${mtUser.id}">查询提现列表</a>
